...
final class EnumTypeExtension implements GrammarProcessing\NodeInterpretation
{

	public function interpret(GrammarProcessing\Node $node): Generator
	{
		return new GraphQL\TypeSystem\TypeExtension(
			new GraphQL\TypeSystem\EnumTypeDefinition(
				description: null,
				...
				enumValues: (yield $node->value[4] ?? null) ?? [],
