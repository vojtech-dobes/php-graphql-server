 ...
 * >
 */
final class TypeInterfacesFieldResolver implements GraphQL\FieldResolver
{
	...
	public function resolveField(mixed $objectValue, GraphQL\FieldSelection $field): mixed
	{
		...
		foreach ($typeDefinition->implementedInterfaces as $interfaceName) {
			$result[] = new GraphQL\Types\NamedType($interfaceName);
		}
